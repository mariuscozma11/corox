...
export const metadata: Metadata = {
  ...
  description:
    "Află povestea Corox Engineering, domeniile noastre de activitate și experiența în automatizări industriale, Machine Safety și soluții tehnice integrate.",
  keywords:
    "despre Corox Engineering, povestea companiei, domenii de activitate, automatizare industrială, Machine Safety, România",
};
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="pt-8">
            ...
            <p className="text-xl max-w-2xl text-left leading-relaxed text-white/80">
              Suntem dedicați oferirii de soluții tehnice de înaltă calitate
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="border-l-4 border-slate-400 bg-white pl-8 py-8 pr-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-left leading-relaxed mb-4">
                  Servicii complete de certificare și evaluare conform
                  standardelor europene, incluzând evaluări de risc și
            ...
            <div className="border-l-4 border-slate-400 bg-white pl-8 py-8 pr-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-left leading-relaxed mb-4">
                  Sisteme de automatizare și integrare de celule robotizate
                  pentru optimizarea proceselor de producție.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-1 h-1 bg-slate-400 mt-2 flex-shrink-0"></div>
                  <span className="text-sm text-gray-600">
                    Integrare de celule robotizate
                  </span>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-1 h-1 bg-slate-400 mt-2 flex-shrink-0"></div>
            ...
            <div className="border-l-4 border-slate-400 bg-white pl-8 py-8 pr-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-left leading-relaxed mb-4">
                  Proiectare și construcție de structuri metalice și sisteme
                  mecanice pentru diverse aplicații industriale.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-start space-x-3">
            ...
            <div className="border-l-4 border-slate-400 bg-white pl-8 py-8 pr-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-left leading-relaxed mb-4">
                  Automatizări și instalații electrice pentru sisteme
                  industriale, cu accent pe eficiență și siguranță.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-start space-x-3">
            ...
            <div className="border-l-4 border-slate-400 bg-white pl-8 py-8 pr-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-left leading-relaxed mb-4">
                  Oferim o gamă de produse standardizate pentru diverse
                  aplicații industriale, disponibile la cerere de ofertă.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-start space-x-3">
            ...
            <div className="border-l-4 border-slate-400 bg-white pl-8 py-8 pr-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-left leading-relaxed mb-4">
                  Servicii de consultanță tehnică specializată pentru
                  optimizarea proceselor și implementarea de soluții inovatoare.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-start space-x-3">
